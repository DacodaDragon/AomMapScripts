...
{	
	// Setup basic map..
	SetUpMap(9400+(cNumberNonGaiaPlayers*250),11000,22000,-8,"SnowA");
	...
	rmAddObjectDefItem        (IDStartingHunt, "boar", 1, 0);
	rmSetObjectDefMinDistance (IDStartingHunt, 23.0);
	rmSetObjectDefMaxDistance (IDStartingHunt, 24.0);
	...
	for(i=1; <cNumberPlayers*5)
	{
		...
		rmSetAreaSize			(AreaSnowPatch, rmAreaTilesToFraction(75), rmAreaTilesToFraction(150));
	...
	for(i=1; <cNumberPlayers*5)
	{
		...
		rmSetAreaSize			(AreaCliffNorse, rmAreaTilesToFraction(5), rmAreaTilesToFraction(20));
	...
	for(i=0; <numTries)
	{
		...
		rmSetAreaSize			(IDelev, rmAreaTilesToFraction(100), rmAreaTilesToFraction(200));
	...
	for(i=0; <forestCount)
	{
		...
		rmSetAreaSize		(forestID, rmAreaTilesToFraction(60), rmAreaTilesToFraction(125));
		}
	...
	rmPlaceObjectDefAtLoc	 	 (IDRock, 0, 0.5, 0.5, 40*cNumberNonGaiaPlayers);
